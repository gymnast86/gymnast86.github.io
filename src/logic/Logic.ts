...
function getCheckType(
    ...
    if (checkType.includes('Beginner Rupees')) {
        return 'beginner_rupee';
    } else if (checkType.includes('Intermediate Rupees')) {
        return 'intermediate_rupee';
    } else if (checkType.includes('Advanced Rupees')) {
        return 'advanced_rupee';
    } else if (checkType.includes('Underground Rupees')) {
