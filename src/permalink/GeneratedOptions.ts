...
export interface GeneratedOptions {
    ...
    /** Rupeesanity */
    'rupeesanity': 'Vanilla' | 'Beginner' | 'Intermediate' | 'Advanced';
    /** Underground Rupeesanity */
    'underground_rupeesanity': boolean;
    /** Gratitude Crystal Shuffle */
    'gratitude_crystal_shuffle': boolean;
    /** Stamina Fruit Shuffle */
    'stamina_fruit_shuffle': boolean;
    /** NPC Closet Shuffle */
    'npc_closet_shuffle': boolean;
    /** Hidden Item Shuffle */
    'hidden_item_shuffle': boolean;
    /** Goddess Chest Shuffle */
    'goddess_chest_shuffle': boolean;
